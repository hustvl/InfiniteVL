    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.mimic_init:
            ...
            nn.init.constant_(self.a_proj.weight, 0.0)
            nn.init.constant_(self.b_proj.weight, 0.0)
        else:
        ...
        if use_short_conv:
            ...
            if self.mimic_init:
                with torch.no_grad():
                    ...
                    self.q_conv1d.weight[:, 0, 3] = 1 
                    self.k_conv1d.weight.zero_()  
                    self.k_conv1d.weight[:, 0, 3] = 1 
                    self.v_conv1d.weight.zero_()  
                    self.v_conv1d.weight[:, 0, 3] = 1 
