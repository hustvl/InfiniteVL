...
from .convert import convert_attention
        ...
        if model_args.mixture_of_depths == "load":
            ...
            if model_args.train_from_scratch:
                ...
                if target_device is not None:
                    ...
                    init_kwargs["device_map"] = {"": target_device}
...
def load_and_convert_model(
    ...
    if model is None and not lazy_load:
        ...
        if model_args.mixture_of_depths == "load":
            ...
            if model_args.train_from_scratch:
                model = load_class.from_config(config, trust_remote_code=model_args.trust_remote_code, torch_dtype=torch.bfloat16)
            else:
                model = load_class.from_pretrained(**init_kwargs)
    ...
    #convert attention
    model = convert_attention(model, finetuning_args)
